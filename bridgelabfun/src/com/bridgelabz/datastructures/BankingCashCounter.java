...
public class BankingCashCounter<T> {
	...
	/**
	 * Driver Method to Calculate the Transaction in Banking Cash Counter
	 * @param args
	 */
		public static void main(String[] args) {
			...
			for (int i = 1; i <= number_people; i++) 
			{
				...
				/*
				 * Add the person who want to do Transaction
				 */
				list1.enqueue(name);
			}
			while(list1.size()>0)
			{
				...
				case 1 :
					...
					/*Remove the person who have done the transaction*/
					list1.dequeue();
					System.out.println("**************************************");
